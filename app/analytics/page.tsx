...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    // ✅ SECURE AUTH: Check with backend instead of localStorage
    checkAuthAndFetch();
  }, [period, router]);
  ...
  const handleLogout = async () => {
    ...
    // Optional: clear local user state if you use it for UI
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            {/* ✅ FIXED KEY: data.summary */}
            <div className="text-3xl font-bold text-gray-900">{data.summary?.total_calls || 0}</div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-indigo-100">
            ...
            <div className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
              {(data.summary?.average_score || 0).toFixed(1)}%
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-green-100">
            ...
            {/* ✅ FIXED KEY: data.summary */}
            <div className="text-3xl font-bold text-green-600">{data.summary?.best_score || 'N/A'}</div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-orange-100">
            ...
            {/* ✅ FIXED KEY: data.agents.length */}
            <div className="text-3xl font-bold text-orange-600">{data.agents?.length || 0}</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={300}>
              {/* ✅ FIXED KEY: data.agents */}
              <BarChart data={data.agents || []}>
                <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                {/* ✅ FIXED KEY: 'agent' not 'name' */}
